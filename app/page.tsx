...
export default function Home() {
  ...
  const manejarSimulacion = async (parametros: {
    ...
    setCargando(true)
    setError(null)
    setPrecioInicial(parametros.precioActual)
    ...
    try {
      ...
      const respuesta = await fetch(url, {
        ...
        body: JSON.stringify({
          precio_actual: parametros.precioActual,
          volatilidad: parametros.volatilidad,
          dias: parametros.dias,
          simulaciones: parametros.simulaciones,
        }),
      })
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {datos && (
              <>
                ...
                {/* Tarjeta de VaR */}
                <TarjetaVar datos={datos} precioInicial={precioInicial} />
