...
export default function TarjetaVar({ datos, precioInicial = 100 }: TarjetaVarProps) {
  // Calculate best case return
  const returnMejorCaso = ((datos.precio_final_maximo - precioInicial) / precioInicial) * 100
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="p-3 bg-chart-1/5 rounded-lg border border-chart-1/20">
              ...
              <p className="text-lg font-bold text-chart-1">{returnMejorCaso.toFixed(1)}%</p>
            </div>
          </div>
        </div>
      </CardContent>
